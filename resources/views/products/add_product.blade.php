				...
				<div class="row">
					...
					<div class="col-sm-3" style="margin-top: 10px">
						<div class="from-group">
							...
							<input type="file" name="card_image" required class="form-control" accept="image/*">
						</div>
					</div>
					...
					<div class="col-sm-3" style="margin-top: 10px">
						<div class="from-group">
							...
							<input type="text" name="name" class="form-control" value="{{old('name')}}" placeholder="الإسم " required="">
						</div>
					</div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <textarea class="form-control"  name="desc" id="editor1" rows="10" cols="80" required></textarea>
                            </div>
